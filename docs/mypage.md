...
**화면 구성 — 탭 3개** (리뷰/커뮤니티/스크랩북 전부 목록이 빡빡해 보이지 않도록 `showDate: false`로 작성 날짜 표시 생략)
...
- **탭 2~3개**: 리뷰 / 커뮤니티 / (조건부) 잉크차트 — 스크랩북 탭은 본인 마이페이지에만 있음 (리뷰/커뮤니티 탭 모두 `showDate: false`로 날짜 생략, 본인 마이페이지와 동일)
