  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: const [
        ...
        _Section(
          '제1조 (목적)',
          '이 약관은 펜귄(이하 "서비스")을 운영하는 운영자(이하 "회사")가 제공하는 만년필·잉크·노트 전문 커뮤니티 및 관련 서비스의 이용과 관련하여 회사와 이용자 간의 권리·의무 및 책임 사항, 기타 필요한 사항을 규정함을 목적으로 합니다.',
        ),
        _Section(
          '제2조 (정의)',
          '① "서비스"란 회사가 제공하는 펜귄 앱 및 이와 관련된 모든 기능을 의미합니다.\n② "이용자"란 이 약관에 동의하고 서비스를 이용하는 회원을 말합니다.\n③ "콘텐츠"란 이용자가 서비스 내에 게시한 리뷰, 게시글, 댓글, 이미지 등 일체의 정보를 말합니다.',
        ),
        _Section(
          '제3조 (약관의 효력 및 변경)',
